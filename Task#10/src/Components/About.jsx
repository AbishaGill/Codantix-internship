...
const About = () => {
  return (
    <section
      ...
      id="about"
    >
      <h2 className="text-xl lg:text-3xl tracking-tight text-center uppercase mb-12 mt-20 mx-4">
        About{" "}
      </h2>
      <div className="flex flex-col items-center lg:space-x-8 mx-4 mb-20">
        ...
        <p className="text-lg lg:text-3xl font-light text-center lg:text-left max-w-5xl mx-auto mt-8">
          ...
          With a passion for design and a commitment to quality, our team
          skilled professionals has been dedicated to delivering exception
